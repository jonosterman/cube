...
public class MachineUuid {
	...
	private MachineUuid() {
		try {
			...
			File uidFile = new File(CubeConfig.getBaseDir(),"machine-uid");
			// check if file already exists
			if (uidFile.exists()) {
				// load 'uuid' property from file
				Properties p = new Properties();
				FileInputStream in = new FileInputStream(uidFile);
				p.loadFromXML(in);
				in.close();
				...
				FileOutputStream out = new FileOutputStream(uidFile);

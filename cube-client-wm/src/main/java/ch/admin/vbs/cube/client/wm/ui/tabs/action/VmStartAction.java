 ...
 * 
 */
public class VmStartAction extends VmAbstractAction {
	 ...
	 */
	public VmStartAction(VmHandle h) {
		super(I18nBundleProvider.getBundle().getString("vm.action.start.text"), IconManager.getInstance().getIcon("start_icon16.png"), h);
	}

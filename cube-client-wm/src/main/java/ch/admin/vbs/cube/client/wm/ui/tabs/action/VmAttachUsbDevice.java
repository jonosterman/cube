 ...
 * 
 */
public class VmAttachUsbDevice extends VmAbstractAction {
     ...
     * 
     */
	public VmAttachUsbDevice(VmHandle h, UsbDeviceEntry usb) {
	...
	public void exec(ActionEvent actionEvent) {
		for (IVmActionListener listener : getVmActionListeners()) {
			listener.attachUsbDevice(getVmHandle(),usb.getDevice());
		}
	}
}

 ...
 * 
 */
public class VmSaveAction extends VmAbstractAction {
	 ...
	 */
	public VmSaveAction(VmHandle h) {
		this(h, true);
	}
	 ...
	 */
	public VmSaveAction(VmHandle h, boolean enabled) {
		super(I18nBundleProvider.getBundle().getString("vm.action.standby.text"), IconManager.getInstance().getIcon("standby_icon16.png"), h);
		setEnabled(enabled);
	}

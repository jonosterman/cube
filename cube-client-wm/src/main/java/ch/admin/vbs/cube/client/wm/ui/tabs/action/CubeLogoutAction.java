...
/**
 * This class handles the logout action for the user logout from cube. When the
 * action is invoke, all listeners will be informed.
 * 
 * 
 * 
 */
public class CubeLogoutAction extends CubeAbstractAction {
	private static final long serialVersionUID = -6477596485040148183L;

	/**
	 * Constructs the cube logout action which will invoke all listeners, when
	 * the action has been executed.
	 */
	public CubeLogoutAction() {
		super(I18nBundleProvider.getBundle().getString("cube.action.logout.text"), IconManager.getInstance().getIcon("logout_icon16.png"));
	}

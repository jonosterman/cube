 ...
 * 
 */
public class VmDeleteAction extends VmAbstractAction {
	 ...
	 */
	public VmDeleteAction(VmHandle h) {
		super(I18nBundleProvider.getBundle().getString("vm.action.delete.text"), IconManager.getInstance().getIcon("trash_icon16.png"), h);
	}

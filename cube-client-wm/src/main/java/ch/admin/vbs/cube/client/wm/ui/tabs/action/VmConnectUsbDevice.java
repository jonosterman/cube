 ...
 * 
 */
public class VmConnectUsbDevice extends VmAbstractAction {
	private static final long serialVersionUID = 0L;

	/**
     * 
     */
	public VmConnectUsbDevice(VmHandle h) {
		super(I18nBundleProvider.getBundle().getString("cube.action.connectusb.text"), IconManager.getInstance().getIcon("usb_icon16.png"), h);
	}
	...
	public void exec(ActionEvent actionEvent) {
		for (IVmActionListener listener : getVmActionListeners()) {
			listener.connectUsbDevice(getVmHandle());
		}
	}
}
